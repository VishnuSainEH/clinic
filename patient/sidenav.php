...
<body>
    <!-- Side Nav -->
    <div class="list-group bg-info " style="height: 94vh;">
        ...
        <a href="appointment.php" class="list-group-item list-group-item-action bg-info text-center text-white">Book Appoinment</a>
